...
if ((UA.indexOf('iphone') != -1 || UA.indexOf('mobile') != -1 || UA.indexOf('android') != -1 || UA.indexOf('ipad') != -1 || UA.indexOf('windows ce') != -1 || UA.indexOf('ipod') != -1) && UA.indexOf('ipod') == -1) {
    if (url.match(/^http:\/\/www\.biquge\.com.tw\/$/) || url.match(/^http:\/\/www\.biquge\.com.tw$/)) {
        Go('http:\/\/m\.biquge\.com.tw');
    }
    if (url.match(/\/\d+?_\d+?\//)) {
        id = url.match(/\/(\d+?)_(\d+?)\//);
        Go(' http://m.biquge.com.tw/wapbook/' + id[2] + '.html');
    }
    if (url.match(/\/\d+?_\d+?\/\d+?\.html/)) {
        id = url.match(/\/(\d+?)_(\d+?)\/(\d+?)\.html/);
        Go(' http://m.biquge.com.tw/wapbook/' + id[2] + '_' + id[3] + '.html');
    }
}
...
function login() {
    document.writeln("<div class=\"ywtop\"><div class=\"ywtop_con\"><div class=\"ywtop_sethome\"><a href=\"/zhuomian.php\">将趣味阅读快捷键下载到桌面</a></div>");
    document.writeln("		<div class=\"ywtop_addfavorite\"><a href=\"javascript:window.external.addFavorite(\'http://www.biquge.com.tw\',\'趣味阅读_书友最值得收藏的网络小说阅读网\')\">收藏趣味阅读</a></div>");
    document.writeln("<a href=\"http:\/\/www.biquge.com.tw\/paihangbang\/\">小说排行榜<\/a>")
    document.write('<div class="nri">');
    if (jieqiUserId != 0 && jieqiUserName != '' && (document.cookie.indexOf('PHPSESSID') != -1 || jieqiUserPassword != '')) {
        if (jieqiUserVip == 1) jieqiUserVipName = '<span class="hottext">至尊VIP-</span>';
        document.write('Hi,<a href="/userdetail.php?uid=' + jieqiUserId + '" target="_top">' + jieqiUserName + '</a>&nbsp;&nbsp;<a href="/modules/article/bookcase.php" target="_top">我的书架</a>');
...
function bqg_panel() {
    document.writeln("<div class=\"header_search\"><form name=\"form\" action=\"/modules/article/soshu.php\" id=\"sform\" target=\"_blank\"><input type=\"text\" value=\" \" name=\"searchkey\" class=\"search\" id=\"wd\"  baiduSug=\"2\" /><button id=\"sss\" type=\"submit\"> 搜 索 </button></form></div>");
    document.writeln("<div class=\"userpanel\">&nbsp;<font color=\"red\">提示：</font>错章奖积分：<a href=\"/newmessage.php?tosys=1\" >错误举报</a><br /><a target=\"_blank\" href=\"/jifen.html\">积分规则</a>&nbsp;&nbsp;<a target=\"_blank\" href=\"/dns.html\">解决跳到别的站</a></div>");
}
...
function mulubd() {
    document.writeln("(提示:已启用缓存技术，最新章节未能及时显示，请强制刷新本页面。)");
}

function footer() {
    document.writeln("<p>本站所有小说为转载作品，所有章节均由网友上传，转载至本站只是为了宣传本书让更多读者欣赏。</p>");
    document.writeln("<p>Copyright &copy; 2018 趣味阅读 All Rights Reserved.</p>");
